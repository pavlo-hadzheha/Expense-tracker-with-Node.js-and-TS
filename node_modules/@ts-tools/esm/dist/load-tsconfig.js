...
export function loadTsconfig(tsconfigPath) {
    const { options } = ts.parseJsonSourceFileConfigFileContent(ts.readJsonConfigFile(tsconfigPath, ts.sys.readFile), ts.sys, dirname(tsconfigPath));
...
//# sourceMappingURL=load-tsconfig.js.map